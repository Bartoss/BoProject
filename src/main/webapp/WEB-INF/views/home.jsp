        ...
        <div class="carousel-item active">
            ...
            <div class="container">
                <div class="carousel-caption text-left">
                    <h1>Welcome to BO Project Music Shop</h1>
                    <p>Here you can browse and buy Instruments, Records and music Accessories. Order Now! </p>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item">
            ...
            <div class="container">
                <div class="carousel-caption text-right">
                    <h1>It's A Music Affair</h1>

                    <p>Through ups and downs, Somehow You manage to survive in life.</p>
